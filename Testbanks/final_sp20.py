...
# class T02Running_Sum(unittest.TestCase):
#     """
...
#     def setUp(self):
#         if not hasattr(final, 'running_sum'):
#             print('! Missing running_sum (skipping test)')
#             raise unittest.SkipTest()

#     def test_0_has_docstring(self):
#         """running_sum() doesn't have a docstring."""
#         if final.running_sum.__doc__ is None:
#             self.fail('running_sum() has no docstring.')

#     def do_test_input(self, numbers, limit):
#         stdin = sys.stdin
#         stdout = sys.stdout
#         instream = io.StringIO()
#         for num in numbers:
#             instream.write(str(num) + "\n")
#         instream.seek(0)
#         try:
#             sys.stdin = instream
#             sys.stdout = io.StringIO()
#             return final.running_sum(limit)
#         finally:
#             sys.stdin = stdin
#             sys.stdout = stdout
...
#         expect = float(expect)
#         rval = self.do_test_input(numbers, limit)
#         self.assertEqual(expect, rval, "You didn't return th number I expected.")


# class T03ListFilter(unittest.TestCase):
#     """
...
#     def setUp(self):
#         if not hasattr(final, 'list_filter'):
#             print('! Missing list_filter (skipping test)')
#             raise unittest.SkipTest()

#     def test_0_has_docstring(self):
#         """list_filter() doesn't have a docstring."""
#         if final.list_filter.__doc__ is None:
#             self.fail('list_filter() has no docstring.')

#     def test_1_check_list(self):
#         """Your list filter didn't give me the list I expected."""
#         print("""+ Testing your list_filter() function""")
#         limit = random.randint(50, 100)
#         numbers = []
#         expect = []
#         for _ in range(100):
#             num = random.randint(0, 2 * limit)
#             numbers.append(num)
#             if num <= limit:
#                 expect.append(num)

#         got = sorted(final.list_filter(numbers, limit))
#         self.assertEqual(len(got), len(expect), "Your list is not the right size.")
#         for i, num in enumerate(sorted(expect)):
#             self.assertEqual(num, got[i], "I see a number in your set that I didn't expect to see.")


# class T04LetterCount(unittest.TestCase):
#     """
...
#     def setUp(self):
#         if not hasattr(final, 'letter_count'):
#             print('! Missing letter_count (skipping test)')
#             raise unittest.SkipTest()

#     def test_0_has_docstring(self):
#         """letter_count() doesn't have a docstring."""
#         if final.list_filter.__doc__ is None:
#             self.fail('letter_count() has no docstring.')
...
#         """You letter counts don't match what I expected."""
...
#         got = final.letter_count(phrase)

#         for k in expected:
#             if k not in got:
#                 self.fail("I expected to see the letter " + k + " in dictionary but it's not there")
#             self.assertEqual(got[k], expected[k], "Your count for the letter " + k + " doesn't match what I expected")
#             del got[k]

#         for k in got:
#             self.fail("You returned a count for " + k + " but that letter shouldn't have been counted.")


# class T05Counter(unittest.TestCase):
#     """
...
#     def setUp(self):
#         if not hasattr(final, 'Counter'):
#             print('! Missing Counter class (skipping test)')
#             raise unittest.SkipTest()

#     def test_0_has_docstring(self):
#         """Class Counterer doesn't have a docstring."""
#         if final.Counter.__doc__ is None:
#             self.fail('Class Counter has no docstring.')
